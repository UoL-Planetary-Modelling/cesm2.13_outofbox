**WACCM-X simulation with electrodynamical ion transport for Fe, Mg and Na under solar minimum conditions**
...
`cp [folder path to store repo on remote server]/SMin_2.run /nobackup/$USER/cesm2/cases/SMin_3M_FX2000_f19f19mg16`
...
**Submit the run**
Submit the job: qsub -cwd SMin_2.run
